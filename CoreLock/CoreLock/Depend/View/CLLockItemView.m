...
- (void)propertySetting:(CGContextRef)ctx {
    ...
    UIColor *color = nil;
    if (_selected) {
        color = [UIColor colorWithHex:coreLockCircleLineSelectedColor];
    } else {
        color = [UIColor colorWithHex:coreLockCircleLineNormalColor];
    }
    [color set];
}
...
- (void)circleSelected:(CGContextRef)ctx rect:(CGRect)rect {
    ...
    [[UIColor colorWithHex:coreLockCircleLineSelectedCircleColor] set];
